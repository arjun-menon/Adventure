...
public:
    ...
    virtual shared_ptr<ImgTex> loadTex(string imageFilePath) = 0;

    virtual void drawImage(const ImgTex &tex, const xy pos, const bool horizontalFlip=false, const double angle=0.0f) = 0;
